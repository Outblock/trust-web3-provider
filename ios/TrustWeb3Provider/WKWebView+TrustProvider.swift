...
extension WKWebView {
     ...
     */
    func generateSwitchAccountJS(address: String, chainId: Int? = nil, network: String = "ethereum") -> String {
     ...
     * @return: JavaScript command string
     */
    func generateSwitchChainJS(chainId: Int, rpcUrl: String? = nil, network: String = "ethereum") -> String {
        let id = Int64(Date().timeIntervalSince1970 * 1000) // Use timestamp as ID
